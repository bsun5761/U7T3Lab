...
//
//        UsedCarLot usedCarLot = new UsedCarLot();
//        usedCarLot.addCar(new Car("Mustang",12500));
//        usedCarLot.addCar(new Car("Camry",8400));
//        usedCarLot.addCar(new Car("Ram",17200));
//        usedCarLot.addCar(new Car("Accent",1980));
//        usedCarLot.addCar(new Car("Cruiser",10500));
//
//        System.out.println(usedCarLot.getInventory());
//
//        boolean test = usedCarLot.swap(2, 4);
//        System.out.println(test);
//        System.out.println(usedCarLot.getInventory());
//
//        test = usedCarLot.swap(1, 2);
//        System.out.println(test);
//        System.out.println(usedCarLot.getInventory());
//
//        test = usedCarLot.swap(-1, 3);
//        System.out.println(test);
//        System.out.println(usedCarLot.getInventory());
//
//        test = usedCarLot.swap(3, 5);
//        System.out.println(test);
//        System.out.println(usedCarLot.getInventory());
//    }
//}
